          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> CMS - Add 
                	<span class="float-right"> 
                		<a href="{{route('cmsadd')}}" class="btn">+ Add Page</a>
                	</span></h4>
              </div>
              <div class="card-body">
                <form method="POST" action="{{ route('cmssave') }}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="row">  
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="description" style="width: 400px;height: 400px;">{{old('description')}}</textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
